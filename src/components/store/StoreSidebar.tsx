...
const navigationConfig: NavSection[] = [
  ...
  },
  {
    title: 'Store',
    items: [
      { to: 'inventory', label: 'Stock & Inventory', icon: Icon.inventory },
      { to: 'requisitions', label: 'Requisitions', icon: Icon.requisitions },
  ...
  },
  {
    title: 'Settings',
    items: [
      { to: 'settings', label: 'Settings', icon: Icon.gatePass },
      { to: 'gate-pass', label: 'Gate Pass', icon: Icon.gatePass },
    ],
  },
];
...
const StoreSidebar: React.FC<StoreSidebarProps> = ({ isOpen = true, onClose }) => {
      ...
      `}>
        ...
        <div className="flex h-16 lg:h-20 items-center justify-between border-b border-stone-100 px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xs font-bold tracking-tight text-stone-900">Store</h2>
