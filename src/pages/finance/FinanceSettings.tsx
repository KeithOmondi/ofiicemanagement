...
const inputClasses =
  ...
  'focus:ring-1 font-serif focus:ring-[#1a3d1c] transition disabled:opacity-50 disabled:cursor-not-allowed';
...
function SectionCard({
  ...
  return (
    <div className="overflow-hidden font-serif rounded-xl border border-stone-200 bg-white">
...
function ProfileTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <div className="grid grid-cols-1 font-serif gap-3 sm:grid-cols-3">
...
const FinanceSettings: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-stone-50 p-6">
      ...
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-stone-900 font-serif uppercase">Settings</h1>
